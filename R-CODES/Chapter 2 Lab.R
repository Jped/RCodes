...
dim(Auto); 
## Added by Dr. Chen ##
n=dim(Auto)[1]; m=dim(Auto)[2]; print(c(n,m))
...
#clicking on "Finish" on top-right concern to exit the identify() function. 
#The numbers printed under the identify() function correspond to the rows for
#the selected points.
#Right-click and use "inspect" button to inspect the printings
##############################################
